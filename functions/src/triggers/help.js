...
exports.sendHelpConfirmEmail = functions.firestore
  .document("help/{userid}")
                                           ...
                                           >
                                             ...
                                             >
                                               ...
                                               ><br /><br /><br /><span
                                                 ...
                                                 >
                                                 We have received your query. Please hold on while we do our best to resolve your issue </span
                                               ><br /><br /><br />
                                             </p>
...
exports.sendSuppotMail = functions.firestore
  .document("help/{userid}")
  .onCreate(async (snap, context) => {
    const newValue = snap.data();
    let mail = await sendEmail(
                                           ...
                                           >
                                             ...
                                             >
                                               ...
                                               ><br /><br /><br /><span
                                                 style="font-size: 18px"
                                                 >
                                                 We have received a query. Please have a look </span
                                               ><br /><br />
                                               name : ${newValue.name}
                                               <br/>

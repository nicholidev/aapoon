                  ...
                  <Stack spacing={5}>
                    <Stack spacing={0}>
                      <ListItem disablePadding>
                        <ListItemButton>
                          <ListItemText secondary={<Typography variant="subtitle1" color="GrayText">Delete</Typography>} />
                        </ListItemButton>
                      </ListItem>
                      <ListItem disablePadding>
                        <ListItemButton>
                          <ListItemText primary={<Typography variant="subtitle1" color="GrayText">Change plan</Typography>} />
                        </ListItemButton>
                      </ListItem>
                      <ListItem disablePadding>
                        <ListItemButton>
                          <ListItemText primary={<Typography variant="subtitle1" color="success.main">Renew</Typography>} />
                        </ListItemButton>
                      </ListItem>
                    </Stack>
                    ...
                    <Stack spacing={0}>
                      <ListItem disablePadding>
                        <ListItemButton>
                          ...
                          <ListItemText secondary={<Typography variant="subtitle1" color="GrayText">Send an email</Typography>} />
                        </ListItemButton>
                      </ListItem>
                    </Stack>
                  </Stack>
